 ...
 * 主文件通过 window.StudioEditorAssetBrowser({ ... }) 注入依赖。
 * 注意：函数保持 2 空格缩进，asset-browser-portal.test.cjs 会按函数名切片执行。
 */
(() => {
  'use strict';

  window.StudioEditorAssetBrowser = function StudioEditorAssetBrowser(deps) {
