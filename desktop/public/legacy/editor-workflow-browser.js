 ...
 * 主文件通过 window.StudioEditorWorkflowBrowser({ state, $, el, nodeById, mutate, toast }) 注入依赖。
 */
(() => {
  'use strict';

  window.StudioEditorWorkflowBrowser = function StudioEditorWorkflowBrowser(deps) {
